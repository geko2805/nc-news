...
function Articles({ searchInputRef, shouldFocusSearch, setShouldFocusSearch }) {
  ...
  //to determine page path eg when on home = "/"
  ...
  // Debounce function - move to utils or use lodash? also used in filterdrawer
  ...
  //make sure search from context syncs up with filters state object search and update URL
  useEffect(() => {
    if (searchQuery !== filters.search) {
      updateSearchFilter(searchQuery);
    }
  }, [searchQuery, updateSearchFilter]);
  ...
  //useEffect for search - client side old method
  // useEffect(() => {
  //   if (searchQuery.trim() === "") {
  //     setFilteredArticles(articles);
  //   } else {
